...
// image default alt
if ( ! function_exists( 'burger_img_default_alt' ) ) {
	function burger_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'burger_img_tag' ) ) {
	function burger_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = burger_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'burger_anchor_tag' ) ) {
	function burger_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'burger_heading_tag' ) ) {
	function burger_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'burger_paragraph_tag' ) ) {
	function burger_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'burger_other_tag' ) ) {
	function burger_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'burger_button_element ' ) ) {
	function burger_button_element( array $args ) {
