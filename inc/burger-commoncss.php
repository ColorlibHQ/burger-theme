...
// enqueue css
function burger_common_custom_css(){
    
    wp_enqueue_style( 'burger-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= burger_opt( 'burger_theme_color' ) != '#131313' ? burger_opt( 'burger_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= burger_opt( 'burger_book_btn_color' ) != '#131313' ? burger_opt('burger_book_btn_color') : '';
		$bookBtnHoverBgColor     	= burger_opt( 'burger_book_btn_hvr_bg_color' ) != '#131313' ? burger_opt('burger_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = burger_opt( 'burger_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = burger_opt( 'burger_navbar_bg_color' ) != '#082b49' ? burger_opt( 'burger_navbar_bg_color') : '';
		$headerTop_col     		  = burger_opt( 'burger_top_header_color' );

		$headerTopBg      		  = burger_opt( 'burger_top_header_bg_color');
		$headerBg          		  = burger_opt( 'burger_header_bg_color') != '#ffffff' ? burger_opt( 'burger_header_bg_color') : '';
		$menuColor          	  = burger_opt( 'burger_header_menu_color' ) != '#131313' ? burger_opt('burger_header_menu_color') : '';
		$menuHoverColor           = burger_opt( 'burger_header_menu_hover_color' ) != '#808080' ? burger_opt('burger_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = burger_opt( 'burger_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = burger_opt( 'burger_header_drop_menu_bg_color' ) != '#ffffff' ? burger_opt('burger_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = burger_opt( 'burger_dropdown_menu_color' ) != '#131313' ? burger_opt('burger_dropdown_menu_color') : '';
		$dropMenuHovColor         = burger_opt( 'burger_dropdown_menu_hover_color' ) != '#808080' ? burger_opt('burger_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = burger_opt( 'burger_footer_widget_bg_color' );
		$footerwHeadColor   	  = burger_opt('burger_footer_widget_heading_color');
		$footerwTextColor   	  = burger_opt('burger_footer_widget_text_color');
		$footerwanchorcolor 	  = burger_opt('burger_footer_widget_anchor_color') != '#ffffff' ? burger_opt('burger_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = burger_opt('burger_footer_widget_anchor_hover_color') != '#ffffff' ? burger_opt('burger_footer_widget_anchor_hover_color') : '';
		
		$fofbg					  = burger_opt('burger_fof_bg_color');
		$foftonecolor			  = burger_opt('burger_fof_textone_color');
		$fofttwocolor			  = burger_opt('burger_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = burger_opt('burger_footer_widget_anchor_color') != '#9e9e9e' ? burger_opt('burger_footer_widget_anchor_color') : '';
		...
		$customcss ="			
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .burger_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .burger_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'burger-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'burger_common_custom_css', 50 );