 ...
 */
	...
	$footer_big_text = burger_opt( 'footer_big_text' ) == '' ? $footer_big_text : burger_opt( 'footer_big_text' );
	$footer_text = burger_opt( 'burger_footer_text' ) == '' ? $footer_text : burger_opt( 'burger_footer_text' );
